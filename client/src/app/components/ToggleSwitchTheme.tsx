...
export default function ToggleSwitchTheme() {
    ...
    return (
        <button
            className={`h-12 w-12 rounded-lg p-2 border shadow-md hover:bg-gray-700 ease-in-out transition-all ${theme === 'light' ? 'bg-white hover:bg-gray-700' : 'bg-gray-700 hover:bg-white border-black'}`}
            onClick={() => handleClick()}
        >
